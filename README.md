...
title: ****                    # 你的博客网站标题
SEOTitle: ******		# SEO 标题
description: "Hey!I'am clyz-mm."	   	   # 随便说点，描述一下

# SNS settings      
github_username: clyz-mm     # 你的github账号
...
要发表的文章一般以 **Markdown** 的格式放在这里`_posts/`，你只要看看篇模板里的文章你就立刻明白该如何设置。
...
### Analytics优点：国际比较流行，界面也很大气、简洁，如果有人评论，还能实时通知，直接回复通知的邮件就行了；
172
​
173
...
遵循 MIT 许可证。有关详细,请参阅 [LICENSE](https://github.com/clyz-mm/clyz-mm.github.io/blob/master/LICENSE)。
